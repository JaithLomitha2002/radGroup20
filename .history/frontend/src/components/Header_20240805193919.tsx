    ...
    <div className="bg-gradient-to-r from-indigo-700 to-rose-700 py-10">
      <div className="container mx-auto flex justify-between">
        ...
        <span className="flex space-x-2">
          {isLoggedIn ? (
            <>
              <Link className="flex items-center text-white bg-gray-200 px-3 font-bold rounded-sm hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400" to="/my-bookings">
                My Bookings
              </Link>
